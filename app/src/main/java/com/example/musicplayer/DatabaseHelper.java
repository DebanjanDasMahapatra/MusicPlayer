...
public class DatabaseHelper {
    ...
    public static void openOrCreateDatabases(Context context) {
        ...
        database.execSQL(String.format(Locale.getDefault(),"CREATE TABLE IF NOT EXISTS %s (%s VARCHAR NOT NULL UNIQUE);",
                context.getString(R.string.playlist_table), context.getString(R.string.playlist_name)));
        database.execSQL(String.format(Locale.getDefault(),"CREATE TABLE IF NOT EXISTS %s (%s VARCHAR NOT NULL, %s VARCHAR NOT NULL, UNIQUE(%s,%s));",
                context.getString(R.string.ps_table), context.getString(R.string.ps_name), context.getString(R.string.ps_location),
                context.getString(R.string.ps_name), context.getString(R.string.ps_location)));
        database.close();
    }
    ...
    public static void createPlaylist(Context context, String name) {
        ...
        myDB.execSQL(String.format(Locale.getDefault(),"INSERT INTO %s (%s) VALUES ('%s');",
                context.getString(R.string.playlist_table), context.getString(R.string.playlist_name), name));
        myDB.close();
    }

    public static void deletePlaylist(Context context, String name) {
        SQLiteDatabase myDB = context.openOrCreateDatabase(context.getString(R.string.db_name), MODE_PRIVATE, null);
        myDB.execSQL(String.format(Locale.getDefault(),"DELETE FROM %s WHERE %s='%s';",
                context.getString(R.string.playlist_table), context.getString(R.string.playlist_name), name));
        myDB.execSQL(String.format(Locale.getDefault(),"DELETE FROM %s WHERE %s='%s';",
                context.getString(R.string.ps_table), context.getString(R.string.ps_name), name));
        myDB.close();
    }

    public static void addSongToPlaylist(Context context, String name, String songLocation) {
        SQLiteDatabase myDB = context.openOrCreateDatabase(context.getString(R.string.db_name), MODE_PRIVATE, null);
        myDB.execSQL(String.format(Locale.getDefault(),"INSERT INTO %s (%s,%s) VALUES ('%s','%s');",
                context.getString(R.string.ps_table), context.getString(R.string.ps_name), context.getString(R.string.ps_location), name, songLocation));
        myDB.close();
    }

    public static void deleteSongFromPlaylist(Context context, String name, String songLocation) {
        SQLiteDatabase myDB = context.openOrCreateDatabase(context.getString(R.string.db_name), MODE_PRIVATE, null);
        myDB.execSQL(String.format(Locale.getDefault(),"DELETE FROM %s WHERE %s='%s' AND %s='%s';",
                context.getString(R.string.ps_table), context.getString(R.string.ps_name), name, context.getString(R.string.ps_location), songLocation));
        myDB.close();
    }
